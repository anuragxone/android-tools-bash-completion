...
## adb
### version: 1.0.41
### android sdk platform-tools version: r35.0.0
### adb official man page: https://android.googlesource.com/platform/packages/modules/adb/+/refs/heads/main/docs/user/adb.1.md
